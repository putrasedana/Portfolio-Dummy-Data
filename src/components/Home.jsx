  ...
  return (
    <div name="home" className="w-full h-screen bg-[#0a192f]">
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <h1 className="text-2xl sm:text-5xl font-bold text-[#ccd6f6]">Sai Kumar</h1>
        ...
        <div>
          <button className="text-white group border-2 px-4 py-3 my-2 flex  items-center hover:bg-pink-700">
            View Projects
